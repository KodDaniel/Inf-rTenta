...
namespace BoxingUnBoxingInförTenta
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Betrakta koden nedan och hänvisa till den när du förklarar varför den ena av...
            //...dessa två listdatastrukturer är att föredra framför den andra.

            // Svar: Boxing uppkommer när en värdetyp ska omvandlas till en referenstyp (typen object). 
            // Värdetyper sparas alltid direkt på stacken, medan referenstyper sparar en referens...
            //...på stacken till ett värde på heapen. När den värdetypen då ska omvandlas...
            ...
            List<int> myList = new List<int>(); // Ingen boxing eftersom den generiska listan behåller...
